    ...
    <div>
      <div className="header-top bg-gradient-to-r from-[#FC004E] via-[#A14F87] to-[#10CBE0] h-[76px] sm:h-[42px] text-center flex items-center justify-center">
        <h1 className="text-white px-[30px] sm:px-[unset]">
          🚀{" "}
          <span className="font-extrabold text-[#00E7F9] lg:text-[22px]">
            FRESH BEGINNINGS SALE:
          </span>{" "}
          <span className="font-bold text-sm lg:text-[22px]">
          ...
          <div className="tai-hero-section-bg overflow-x-hidden">
            <div className="hero-wrapper container">
              <div className="hero-content sm:relative">
                <h1 className="hero-title text-white text-center sm:text-left font-bold pt-[5px] sm:pt-[0px] mb-[4px]">
                  Want to Turn Social Media <br className="sm:hidden" />
                  Into a Profitable Career?
                </h1>
                <div className="mcdonalds-logo-wrapper text-center sm:text-left font-bold mb-[22px]">
                  <span className="double-text-shadow hero-title">
                    Discover your way to success with Fametonic:
                  </span>
                  <span className="double-text-main hero-title">
                    Discover your way to success with Fametonic:
                  </span>
                </div>
                <ul className="text-white mb-[22px] sm:mb-[28px]">
                ...
                <div className="flex flex-col sm:flex-col-reverse">
                  <div className="text-center sm:text-left">
                    <p className="px-[20px] sm:px-[unset] text-[#ABABAB] mb-[10px]  text-xs">
                      By clicking &quot;Get Started&quot;, you agree with Terms
                      and Conditions, Privacy Policy, Subscription Terms
                    </p>
                    <p className="copyright text-[#ABABAB] text-[10px] nunito mb-[32px] sm:mb-[0px]">
              ...
              <div className="hero-image">
                <Image
                  className="mt-[-18px] block sm:hidden"
                  width={580}
                  height={615}
                  src="/hero-image.png"
                  alt="Mobile Phone"
                />
                <Image
                  className="hidden sm:block md:mt-[unset] sm:min-w-[418px] lg:min-w-[564px] xl:min-w-[666px] sm:ml-[-61px] lg:ml-[-99px] xl:ml-[-62px] sm:pr-[unset]"
                  width={580}
                  height={334}
